...
public class ProjectileManager {
	...
	public void newProjectile(Tower t, Enemy e) {
		...
		projectiles.add(new Projectiles(t.getX() + 16, t.getY() + 16, xSpeed, ySpeed, t.getDmg(), rotate, projectile_id++, type));
	...
	private void drawExplosions(Graphics2D g2d) {
       ...
       for(Explosion e: explosions) {
    	   if(e.getIndex() < 7) {
    		   g2d.drawImage(explosion_imgs[e.getIndex()], (int)e.getPos().x-16, (int)e.getPos().y-16, null);
    	   }
       }	
	}
